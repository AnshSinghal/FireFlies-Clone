 ...
 *
 * 3140/8140 rather than the round 3100/8100: those are the numbers every other
 * tool on a shared box reaches for first, and Playwright's answer to an
 * occupied port is to refuse to start — correct, and it stops the suite dead.
 * Anything in the 41xx/81xx range would do; what matters is that they are not
 * the obvious ones.
 *
