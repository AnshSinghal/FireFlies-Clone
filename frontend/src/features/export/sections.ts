 ...
 *
 * Comments joined the list when T-31 landed — the line below was the whole
 * registration, exactly as planned. Highlights (T-32) is still being built on
 * a parallel branch; the API already ACCEPTS `include=highlights` and renders
 * it once its table exists, so adding it here is again one line:
 *
