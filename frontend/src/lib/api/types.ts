...
export type ParticipantDetail = Schemas['ParticipantDetail']
export type ActionItemOut = Schemas['ActionItemOut']
export type ChannelRef = Schemas['ChannelRef']
export type TagRef = Schemas['TagRef']
export type TagOut = Schemas['TagOut']
export type TagFacet = Schemas['TagFacet']
export type TagProposal = Schemas['TagProposal']
...
export type BulkRestoreResponse = Schemas['BulkRestoreResponse']
...
export type HighlightColor = HighlightOut['color']
