...
## ADR-097 — Search syntax is parsed once, into two languages
...
## ADR-098 — The search total is stable across pages
...
## ADR-099 — A snippet's deep link carries both halves of the answer
